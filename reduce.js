...
function vowelCount(str) {
   ...
   return strArray.reduce(function(accumulator, nextValue){
    let lowercase = nextValue.toLowerCase();
...
specific value is true, the value should be placed in the first subarray. If the result of the callback function at that 
